# This data borrowed from MolKit is modified.
# http://mgltools.scripps.edu/api/MolKit/MolKit.parm94_dat-pysrc.html
# -------------------------------------------------------------------
...
#
# ---------------------------------------------------------------------
title = "PARM94 for DNA, RNA and proteins with TIP3P Water. "\
        "USE SCEE=1.2 in energy progs"
...
bondTypes = {
    ...
    'CA-HA': [367.0, 1.080,
              "changed from 340. bsd on C6H6 nmodes; PHE,TRP,TYR"],
    'CA-H4': [367.0, 1.080,
              "changed from 340. bsd on C6H6 nmodes; no assigned"],
    ...
    'CM-H5': [367.0, 1.080,
              "changed from 340. bsd on C6H6 nmodes; not assigned"],
    ...
    'CT-H3': [340.0, 1.090,
              "changed from 331 bsd on NMA nmodes; not assigned"],
    'CT-HP': [340.0, 1.090,
              " changed from 331; AA-lysine, methyl ammonium cation"],
    ...
    'C*-HC': [367.0, 1.080,
              "changed from 340. bsd on C6H6 nmodes, not needed AA"],
    ...
    'CW-H4': [367.0, 1.080,
              "changed from 340. bsd on C6H6 nmodes;HIS(epsilon,+)"],
