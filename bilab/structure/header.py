...
from bilab.structure.atomic import Atomic, AtomGroup
from bilab.structure.atomic import getSequence
from bilab.structure.transform import Transformation
...
class Chemical(object):
    ...
    .. ipython:: python
       ...
       from bilab.structure import parsePDBHeader
       chemical = parsePDBHeader('1zz2.pdb', 'chemicals')[0]
       chemical
       chemical.name
       chemical.natoms
       len(chemical)"""
...
class Polymer(object):
    ...
    .. ipython:: python
       ...
       from bilab.structure import parsePDBHeader
       polymer = parsePDBHeader('2k39.pdb', 'polymers')[0]
       polymer
       polymer.pdbentry
       polymer.chid
       polymer.name
