...
from bilab.structure.atomic import Atomic, Residue, Atom
from bilab.utilities import importLA, checkCoords
...
def calcADPAxes(atoms, **kwargs):
    ...
    .. ipython:: python
       ...
       from bilab.structure import parsePDB, calcADPAxes
       protein = parsePDB('1ejg.pdb')
...
def buildADPMatrix(atoms):
    ...
    .. ipython:: python
       ...
       from bilab.structure import parsePDB, buildADPMatrix
       from bilab.structure.atomic import pyparsing
       protein = parsePDB('1ejg.pdb')
       calphas = protein.select('calpha')
