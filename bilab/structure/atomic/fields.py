...
ATOMIC_FIELDS = {
    ...
    'resname':   Field('resname', DTYPE + '6', 
                       doc='residue name',
                       selstr=('resname ALA GLY',)),
    'resnum':    Field('resnum', int, 
                       doc='residue number', none=HVNONE,
...
Many of these data fields can be used to make :ref:`select`.
