...
cdef extern from "MMTK/forcefield.h":
    ...
    ctypedef class bilab.structure.minimization._MMTK_forcefield.EnergyTerm [object PyFFEnergyTermObject]:
        cdef int index
    ...
    ctypedef class bilab.structure.minimization._MMTK_forcefield.EnergyEvaluator \
