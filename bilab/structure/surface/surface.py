...
try:
    from bilab.structure.surface import _nsc as nsc
except ImportError:
    # raise ImportError('_nsc() function could not be imported. '
    #                      'Reinstall bilab may solve the problem.')
    warnings.warn("failed to import _nsc module; using slow alternative.")
