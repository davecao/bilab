...
ELEMENT_FIELDS = {
    ...
    'StandardName':  ElementProperties(
                        'StandardName', np.str,
                        doc='Name of the element, e.g., Hydrogen'),

    'Symbol': ElementProperties(
                    'Symbol', DTYPE,
                    doc=' the symbol of the element'),

    'Abbreviation': ElementProperties(
                        'Abbreviation', DTYPE,
                        doc='Abbreviation of the element'),

    'AtomicNumber': ElementProperties(
                    'AtomicNumber', int,
                    doc='atomic number Z',
    ...
    'AtomicWeight': ElementProperties(
                        'AtomicWeight', float,
                        doc='atomic weight'),

    'AtomicMass': ElementProperties(
                        'AtomicMass', DTYPE,
                        doc='Atomic mass of the element'),

    'Color': ElementProperties(
                    'Color', float, ndim=3,
    ...
    'Group': ElementProperties(
                    'Group', int,
                    doc='the group of the element in the periodic table'),

    'Period': ElementProperties(
                    'Period', int,
                    doc='the period of the element in the periodic table'),

    'CrystalStructure': ElementProperties(
                    'CrystalStructure', DTYPE,
                    doc='the type of crystal structure'),

    'LatticeAngles': ElementProperties(
                    'LatticeAngles', float, ndim=3,
                    doc='lattic angle in crystal structure'),

    'LatticeConstants': ElementProperties(
                    'LatticeAngles', float, ndim=3,
                    doc='lattic constants(x, y, z) in crystal structure'),

    'SpaceGroupNumber': ElementProperties(
                    'SpaceGroupNumber', int,
                    doc='space group number.'),

    'SpaceGroup': ElementProperties(
                    'SpaceGroup', DTYPE,
                    doc='space group., i.e., P63/mmc'),

    'AtomicRadius': ElementProperties(
                    'AtomicRadius', float,
                    doc='atmoic radius of the element in pm 10x10^-12'),

    'CovalentRadius': ElementProperties(
                    'CovalentRadius', float,
                    doc='covalent raidus of the element'),

    'VanDerWaalsRadius': ElementProperties(
                    'VanDerWaalsRadius', float,
                    doc='van der Waal radius of the element.'),

    'ElectronConfiguration': ElementProperties(
                    'ElectronConfiguration', DTYPE,
                    doc='The electron configuration., i.e., H for 1s1'),

    'ElectronConfigurationString': ElementProperties(
                    'ElectronConfigurationString', DTYPE,
                    doc='A string of the electron configuration'),

    'ElectronShellConfiguration': ElementProperties(
                    'ElectronShellConfiguration', DTYPE,
                    doc='The electron shell configuration., i.e., '),

    'IonizationEnergies': ElementProperties(
                    'IonizationEnergies', float,
                    doc='First ionization energy of the element. i.e., H for'
                    '1312kj/mol'),

    'QuantumNumbers': ElementProperties(
                    'QuantumNumbers', DTYPE,
                    doc='Quantum number of the element'),

    'CASNumber': ElementProperties(
                    'CASNumber', DTYPE,
                    doc='CAS number of the element'),

    'PubChemCID': ElementProperties(
                    'PubChemCID', DTYPE,
                    doc='PubChem CID of the element'),

    'Category': ElementProperties(
                    'Category', DTYPE,
